                    ...
                    <div class="card-body">
                        <form action="{{ route('cars.index') }}" method="GET">
                            ...
                            <div class="form-group">
                                ...
                                <input type                             name="model" id="model" class="form-control" value="{{ Request::get('model') }}">
                            </div>
                        ...
                        <hr>
                        <div class="mb-3">
                            <a href="{{ route('cars.create') }}" class="btn btn-success">{{ __("messages.addCar") }}</a>
                        </div>
                        <table class="table">
                            <thead>
                                <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form action="{{ route('cars.destroy', $car->id) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="btn btn-danger" onclick="return confirm('{{ __("messages.confirmDelete") }}')">{{ __("messages.delete") }}</button>
                                            </form>
                                        </td>
                                    </tr>
                                @endforeach
